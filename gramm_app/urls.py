...
from .views import index, PostCreateView, PostDetailView, PostUpdateView, PostDeleteView, PostListView, LikeView, is_was_liker
...
urlpatterns = [
    ...
    path('is_was_liker/<int:pk>', is_was_liker, name='is-liker'),
]
