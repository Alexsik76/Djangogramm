...
from .views import index, PostCreateView, PostDetailView, PostUpdateView, PostDeleteView, PostListView, LikeView, LikeView2
...
urlpatterns = [
    ...
    path('likes/<int:pk>', LikeView2.as_view(), name='likes'),
]
